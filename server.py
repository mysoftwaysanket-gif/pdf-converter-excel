...
def consolidated_mcc_admitted_converter(file):
    import pdfplumber
    import pandas as pd
    import io
...
def medical_fee_converter(file):
    all_rows = []
    header = None
...
def selection_list_converter(file):
...
def provisional_merit_list_converter(file):
    all_rows = []
    header = None
...
def merit_list_aiq_converter(file):
...
def bds_fee_structure_converter(file):
    import pdfplumber
    import pandas as pd
    import io
    import re
...
def convert():
    ...
    try:
        csv_buffer = converters[category](file)

        original_name = os.path.splitext(file.filename)[0]
        output_filename = original_name + ".csv"
